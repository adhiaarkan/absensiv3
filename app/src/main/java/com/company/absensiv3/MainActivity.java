...
import com.company.absensiv3.adapters.AdapterRuangBelajarDialog;
import com.company.absensiv3.model.Kehadiran;
import com.company.absensiv3.model.Profile;
import com.company.absensiv3.model.RuangBelajar;
import com.company.absensiv3.model.Status;
import com.company.absensiv3.model.Versi;
import com.company.absensiv3.pages.PageImportData;
import com.company.absensiv3.pages.PageLog;
import com.company.absensiv3.pages.PageProfile;
import com.company.absensiv3.pages.PageRekapData;
import com.company.absensiv3.pages.PageUpdate;
import com.company.absensiv3.pages.kehadiran.PageCatatanKehadiran;
import com.company.absensiv3.pages.penilaian.PageCatatanPenilaian;
import com.company.absensiv3.pages.sikapprilaku.PageCatatanSikapPrilaku;
import com.company.absensiv3.pages.PageDaftarSiswa;
import com.company.absensiv3.pages.PageMataPelajaran;
import com.company.absensiv3.pages.PageRuangBelajar;
import com.company.absensiv3.utils.DatabaseHelper;
import com.company.absensiv3.utils.Iklan;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv1hadir.setText("0 Anak"); //hadir
        tv2izin.setText("0 Anak"); //izin
        tv3terlambat.setText("0 Anak"); //terlambat
        tv4sakit.setText("0 Anak"); //sakit
        tv5alfa.setText("0 Anak"); //alfa
        tv6ruang.setText("0 Ruangan"); //ruang
        tv7diampu.setText("0 Anak"); //diampu
        tv8pelajaran.setText("0 Materi"); //pelajaran
        ...
        db.collection("users/"+getUserID+"/ruangbelajar")
                .addSnapshotListener((value1, e1) -> {
                    ...
                    tv6ruang.setText(jumlah1 +" Ruang");
                    ...
                    db.collection("users/"+getUserID+"/siswa")
                            .addSnapshotListener((value2, e2) -> {
                                ...
                                tv7diampu.setText(jumlah2 +" Anak");
                                ...
                                db.collection("users/"+getUserID+"/matapelajaran")
                                        .addSnapshotListener((value3, e3) -> {
                                            ...
                                            tv8pelajaran.setText(jumlah3 +" Materi");
                                            ...
                                            db.collection("users/"+getUserID+"/kehadiran")
                                                    .addSnapshotListener((value4, e4) -> {
                                                        ...
                                                        tv1hadir.setText(hadir+" Anak");
                                                        tv5alfa.setText(alfa+" Anak");
                                                        tv2izin.setText(izin+" Anak");
                                                        tv4sakit.setText(sakit+" Anak");
                                                        tv3terlambat.setText(terlambat+" Anak");
                ...
                if(items.size() > 0){
                    ...
                    listView.setOnItemClickListener((adapterView, view1, which, l) -> {
                        ...
                        if(TextUtils.isEmpty(items.get(which).kelas_desc)){
                            Toast.makeText(view.getContext(),"Kelas tidak ditemukan!",Toast.LENGTH_SHORT).show();
                        }else{

                            Intent intent = new Intent(context, PageDaftarSiswa.class);
                            intent.putExtra("kelas", items.get(which).kelas_desc);
                            startActivity(intent);
                    ...
                    Toast.makeText(view.getContext(),"Harap tambahkan kelas dahulu!",Toast.LENGTH_SHORT).show();
                }
                        ...
                        try{
                            ...
                            if( p != null ){
                                ...
                                if(!TextUtils.isEmpty(p.asal_sekolah)){
                                    ...
                                    SharedPreferences.Editor editor = sharedpreferences.edit();
                                    editor.putString("asalsekolah",p.asal_sekolah);
                                    editor.apply();
                                ...
                                if(!TextUtils.isEmpty(p.semester)){
                                    ...
                                    SharedPreferences.Editor editor = sharedpreferences.edit();
                                    editor.putString("semester",p.semester);
                                    editor.apply();
