...
public class PageMataPelajaran extends AppCompatActivity {
    ...
    private void init(){
        ...
        bottomSheetLayout.findViewById(R.id.action_simpan).setOnClickListener(v -> {
            ...
            if(!TextUtils.isEmpty(key)){
                //update
                db.collection("users/" + getUserID + "/matapelajaran").document(key).set(
                ...
                //add
                db.collection("users/" + getUserID + "/matapelajaran").add(
                        new MataPelajaran(nama,desc)
                ).addOnSuccessListener(documentReference -> {
    ...
    private void getList(){
        db.collection("users/"+getUserID+"/matapelajaran")
                .orderBy("pelajaran_nama", Query.Direction.ASCENDING)
        ...
        public void onBindViewHolder(@NonNull AdapterViewHolder holder, int position) {
            ...
            holder.actDel.setOnClickListener(v -> {
                ...
                sweetAlertDialog.setConfirmClickListener(sDialog -> {
                    ...
                    db.collection("users/" + getUserID + "/matapelajaran").document(docId).delete();
                });
